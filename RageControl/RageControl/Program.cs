...
// https://www.joduska.me/forum/topic/77019-antiflame-ragecontrol/
// assembly of: Foxy4Eva
// I just fixed so you can curse when you're whispering someone
...
namespace RageControl
{
    internal class Program
    {
        ...
        #endregion
        static List <string> _badWords = new List<string> { "ass", "fck", "cancer", "fak", "fcuk","bastard", "braindead", "l2p", "fk", "cunt", "dick", "fuck", "kurwa", "shit", "suck", "mom", "kid", "noob", "retard", "cunt", "feeder", "bronzie", "nab", "tard", "idiot", "moron", "mother" };
        static List<string>_whiteList = new List<string> { "kass","kassadin", "cass", "afk", "faker", "Faker" };
        static List<string> _allowed = new List<string> { "/msg", "/w" };
